...
CREATE TABLE `status_updates` (
  ...
  `new_status` enum('ASSIGNED','IN_PROGRESS','REJECTED','REPORTED','RESOLVED') NOT NULL,
  `report_id` bigint NOT NULL,
  `technician_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKtpveot3fqjht88rnffms5xjm6` (`report_id`),
  KEY `FKf3a3w7j742dri71r9ru4uqjmr` (`technician_id`),
  CONSTRAINT `FKf3a3w7j742dri71r9ru4uqjmr` FOREIGN KEY (`technician_id`) REFERENCES `technicians` (`id`),
  CONSTRAINT `FKtpveot3fqjht88rnffms5xjm6` FOREIGN KEY (`report_id`) REFERENCES `water_reports` (`id`)
